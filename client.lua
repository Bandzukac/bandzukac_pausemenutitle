function AddFontTextEntry(entry, text)
    AddTextEntry(entry, "<FONT FACE='Roboto Condensed'> " .. text .. " </FONT>")  -- custom font
end

AddFontTextEntry('FE_THDR_GTAO', 'Roleplay Name') -- add here your name
--
